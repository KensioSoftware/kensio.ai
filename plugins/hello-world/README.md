...
A minimal example skill that demonstrates the shape of a Kensio plugin. Install it to verify that
the marketplace is wired up correctly, then uninstall it.
